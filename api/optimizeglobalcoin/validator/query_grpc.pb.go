...
const (
	Query_Params_FullMethodName       = "/optimizeglobalcoin.validator.Query/Params"
	Query_Validator_FullMethodName    = "/optimizeglobalcoin.validator.Query/Validator"
	Query_ValidatorAll_FullMethodName = "/optimizeglobalcoin.validator.Query/ValidatorAll"
)
...
func (c *queryClient) ValidatorAll(ctx context.Context, in *QueryAllValidatorRequest, opts ...grpc.CallOption) (*QueryAllValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ValidatorAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Validator(context.Context, *QueryGetValidatorRequest) (*QueryGetValidatorResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Validator not implemented")
}
func (UnimplementedQueryServer) ValidatorAll(context.Context, *QueryAllValidatorRequest) (*QueryAllValidatorResponse, error) {
...
func _Query_ValidatorAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ValidatorAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
