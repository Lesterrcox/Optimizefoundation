...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"optimizeglobalcoin", "validator", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Validator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"optimizeglobalcoin", "validator", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ValidatorAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1}, []string{"optimizeglobalcoin", "validator"}, "", runtime.AssumeColonVerbOpt(false)))
)
