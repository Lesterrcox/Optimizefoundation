...
func New(
	...
	// Register crossflow custom modules
	if err := app.registerCustomModules(appOpts); err != nil {
		return nil, err
	}
...
func RegisterCoinDenominations() {
	_ = sdk.RegisterDenom("OGC", sdkmath.LegacyOneDec())
	_ = sdk.RegisterDenom("uogc", sdkmath.LegacyNewDecWithPrec(1, 6))
}
